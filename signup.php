    ...
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
        <form role="form" id="signup" method="post" action="scripts/check_signup.php">
            ...
            <div class="row">
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <div class="form-group">
                        <select name="country" id="country" tabindex="4">
...
<!--<input type="country" name="country" id="country" />-->
                ...
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <div class="form-group">
                        <input type="text" name="handle" id="handle" class="form-control input-lg" placeholder="Handle" tabindex="5">
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <div class="form-group">
                        <input type="password" name="verify_password" id="verify_password" class="form-control input-lg" placeholder="Confirm Password" tabindex="7">
                    </div>
                </div>
            </div>
